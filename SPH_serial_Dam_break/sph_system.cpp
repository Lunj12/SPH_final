...
void SPHSystem::init_system()
{
	...
	for(pos.x=world_size.x*0.0f+kernel*1.0f; pos.x<world_size.x*0.4f-kernel*0.25f; pos.x+=(kernel*cutoff_ratio))
	{
		for(pos.y=world_size.y*0.0f+kernel; pos.y<world_size.y*0.5f-kernel*0.25f; pos.y+=(kernel*cutoff_ratio))
		{
