...
void SPHSystem::init_system()
{
	...
	for(pos.x=world_size.x*0.0f+kernel*0.75f; pos.x<world_size.x*1.0f-kernel*0.25f; pos.x+=(kernel*0.45f))
	{
		for(pos.y=world_size.y*0.0f+kernel; pos.y<world_size.y*0.4f-kernel*0.25f; pos.y+=(kernel*0.45f))
		{
