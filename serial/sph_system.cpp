...
SPHSystem::SPHSystem(float input_world_size, float input_cutoff_ratio)
{
	...
	world_size.x=input_world_size;
	world_size.y=input_world_size;
...
// Add bottom boundary
	 ...
	 for(pos.x=world_size.x*0.0f+kernel/2; pos.x<world_size.x*1.0f-kernel/2; pos.x+=(kernel*cutoff_ratio))
 	{
	...
	for(pos.y=world_size.y*0.0f+kernel/2; pos.y<world_size.y*1.0f-kernel/2; pos.y+=(kernel*cutoff_ratio))
	{
